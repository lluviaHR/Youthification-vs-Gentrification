...
data90_00$Inc90_00<- ifelse(data90_00$percentil90Income < data90_00$percentil00Income,data90_00$percentil00Income, 0)
#Compare percentiles Median Home Value
data90_00$HValue90_00<- ifelse(data90_00$percentil90HValue < data90_00$percentil00HValue,data90_00$percentil00HValue, 0)
#Compare percentiles Education Attaiment
data90_00$EAtt90_00<- ifelse(data90_00$percentil90EduAtt < data90_00$percentil00EduAtt, data90_00$percentil00EduAtt, 0)
#Compare percentiles Age 25 to 34
data90_00$Age2590_00<- ifelse(data90_00$percentil90Age25_34 < data90_00$percentil00Age25_34, data90_00$percentil00Age25_34, 0)
...
data00_10$Inc00_10<- ifelse(data00_10$percentil00Income < data00_10$percentil10Income,data00_10$percentil10Income, 0)
#Compare percentiles Median Home Value
data00_10$HValue00_10<- ifelse(data00_10$percentil00HValue < data00_10$percentil10HValue,data00_10$percentil10HValue, 0)
#Compare percentiles Education Attaiment
data00_10$EAtt00_10<- ifelse(data00_10$percentil00EduAtt < data00_10$percentil10EduAtt, data00_10$percentil10EduAtt, 0)
#Compare percentiles Age 25 to 34
data00_10$Age2500_10<- ifelse(data00_10$percentil00Age25_34 < data00_10$percentil10Age25_34, data00_10$percentil10Age25_34, 0)

#================= Comparing percentiles 90 to 2010 ==============================================================
#After merging 90s to 2000 all inclusive
#Compare percentiles Median Household Income
data90_10$Inc90_10<- ifelse(data90_10$percentil90Income < data90_10$percentil10Income,data90_10$percentil10Income, 0)
#Compare percentiles Median Home Value
data90_10$HValue90_10<- ifelse(data90_10$percentil90HValue < data90_10$percentil10HValue,data90_10$percentil10HValue, 0)
#Compare percentiles Education Attaiment
data90_10$EAtt90_10<- ifelse(data90_10$percentil90EduAtt < data90_10$percentil10EduAtt, data90_10$percentil10EduAtt, 0)
#Compare percentiles Age 25 to 34
data90_10$Age2590_10<- ifelse(data90_10$percentil90Age25_34 < data90_10$percentil10Age25_34, data90_10$percentil10Age25_34, 0)
#===================+++++++++++++++++++++++++++=============
...
#replace(data90_10, is.na(data90_10), "99")
